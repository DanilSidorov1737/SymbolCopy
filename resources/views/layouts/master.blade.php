...
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js"></script>
  ...
  <link href="vendor/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="vendor/vendor/quill/quill.snow.css" rel="stylesheet">
  <link href="vendor/vendor/quill/quill.bubble.css" rel="stylesheet">
  <link href="vendor/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="vendor/vendor/simple-datatables/style.css" rel="stylesheet"> -->
  ...
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item dropdown pe-3">
      ...
      <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
        <img src="/storage/{{auth()->user()->profile->image}}" alt="Profile" class="rounded-circle">
...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="/profile/{{ Auth::id() }}">
      <i class="bi bi-person"></i>
      <span>Profile</span>
    </a>
...
<main id="main" class="main">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>OnyxApp</span></strong>. All Rights Reserved
    </div>
